...
public class NecrologyAdapter extends RecyclerView.Adapter<NecrologyAdapter.ViewHolder> implements View.OnCreateContextMenuListener {
    ...
    public NecrologyAdapter(Context applicationContext, List<NecrologyModel> itemArrayList) {
    ...
    @NonNull
    @Override
    public NecrologyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adusum_list_brother, viewGroup, false);
        view.setOnCreateContextMenuListener(this);
        return new NecrologyAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NecrologyAdapter.ViewHolder viewHolder, int i) {
